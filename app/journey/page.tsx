      ...
      >
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="mb-4 font-medium leading-[1.8] text-slate-200">{data.description}</p>
      ...
      <section ref={heroRef} className="relative min-h-[70vh] flex items-center justify-center overflow-hidden pt-32 pb-20">
        ...
        >
          ...
          >
            ...
            <p className="mx-auto max-w-2xl text-lg font-medium leading-[1.8] text-slate-200 md:text-xl">
          ...
          <Card3DParallax intensity={0.7} delay={0.2}>
            <div className="glass-card p-12 md:p-20 text-center max-w-4xl mx-auto relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="mb-8 text-lg font-medium leading-[1.8] text-slate-200">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  {['Next.js', 'Three.js', 'AI Integration', 'Enterprise Apps', 'Trading Systems'].map((tag, i) => (
                    <motion.span
                      ...
                      className="rounded-full border border-white/10 bg-[#0d1528] px-4 py-2 text-sm text-slate-200 transition-colors hover:border-cosmic-accent/50"
                    >
                      {tag}
                    </motion.span>
                  ))}

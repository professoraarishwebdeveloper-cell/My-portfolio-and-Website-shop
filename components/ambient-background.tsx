...
const orbs = [
  {
    className: 'left-[-8%] top-[-6%] h-[520px] w-[520px] bg-[#6be7ff]/30',
    animate: { x: [0, 40, 0], y: [0, 30, 0], scale: [1, 1.08, 1] },
    duration: 22,
  },
  {
    className: 'right-[-6%] top-[12%] h-[460px] w-[460px] bg-[#ff8b5b]/24',
    animate: { x: [0, -35, 0], y: [0, 45, 0], scale: [1, 1.12, 1] },
    duration: 26,
  },
  {
    className: 'bottom-[-10%] left-[28%] h-[540px] w-[540px] bg-[#ffd166]/18',
    animate: { x: [0, 30, 0], y: [0, -35, 0], scale: [1, 1.06, 1] },
    duration: 24,
  },
  {
    className: 'bottom-[8%] right-[18%] h-[320px] w-[320px] bg-[#5e8bff]/18',
